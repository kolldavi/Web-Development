function loadData() {
	...
	if ($('#city').val() !== '') {
		...
		var imageUrl =
			'http://maps.googleapis.com/maps/api/streetview?size=600x500&location=' +
			location +
		...
		var newYorkTimesUrl =
			...
			cityString +
			'&sort=newest&api-key=n4yp5Ep6Jbt73frdgdeUVHxGo0dYxlVh';
		...
		var wikiURL =
			...
			cityString +
			'&format=json&json&callback=wikiCallback';
		console.log(wikiURL);
		// Using jQuery
		var atricleText;
